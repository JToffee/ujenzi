...
<section id="notifications">
  <div class ="row">
    <?php
      $sql = " SELECT * FROM jobtaken WHERE clientemail = ? ";
        ...
        if ($count>0) {
            ...
            while ($row = $query -> fetch()) {
              ...
              $stmt = $conn-> prepare("SELECT * FROM user WHERE email = ?");
                ...
                $result = $stmt ->fetch();
              echo '<form method="post" action = "takejob.php">
							<div id="user" style = "">
              ...
              <div id="message">
                ...
                <input type = "text" name = "details"  value = "'.$row['datetaken'].'"><br>
                <button name=""> Job Confirmed </button>
							</div>
                </form>';
            }
       } else {
